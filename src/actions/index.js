...
export const loadCategories = () => (dispatch, getState) => dispatch({
...
export const loadPostsOfCategory = category => (dispatch, getState) => dispatch({
...
export const loadPosts = () => (dispatch, getState) => dispatch({
...
export const loadPost = id => (dispatch, getState) => dispatch({
...
export const loadCommentsOfPost = id => (dispatch, getState) => dispatch({
...
export const editPost = changedPost => dispatch => dispatch({
...
export const votePost = ({id, option}) => dispatch => dispatch({
...
export const editComment = changedComment => dispatch => dispatch({
...
export const voteComment = ({ id, option }) => dispatch => dispatch({
